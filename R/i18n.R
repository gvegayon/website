...
I18N <- list(
  en = list(
    ...
    talk_with        = "with {names}",
    talk_presented_by = "Presented by {name}",
    talks_proxy_note = "Presented by a co-author, not by me.",
    date_fmt         = "{month} {day}",
  ...
  es = list(
    ...
    talk_with        = "con {names}",
    talk_presented_by = "Presentada por {name}",
    talks_proxy_note = "Presentada por un coautor, no por mí.",
    date_fmt         = "{day} {month}",
  ...
  zh = list(
    ...
    announcement     = "公告",
    talk_with        = "合作者：{names}",
    talk_presented_by = "由 {name} 發表",
    talks_proxy_note = "由合作者發表，非本人。",
    date_fmt         = "{month}{day}日",
    invited_talk           = "受邀演講",
